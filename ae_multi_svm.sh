...
nice -9 taskset -c 20-50 python ae_svm_multi_classifiers.py --data_act ${act_files[@]} --data_in ${inact_files[@]} --pretrain_epochs 75 --dims_layers_ae 7000 4000 500 1000 100 --batch_size 50 --lr 0.0001 --dir_save /mnt/users/struski/local/chemia/multi_svm_classifers_5 --use_dropout --class_weight
...
nice -9 taskset -c 20-50 python ae_svm_multi_classifiers.py --data_act ${act_files[@]} --data_in ${inact_files[@]} --pretrain_epochs 75 --dims_layers_ae 7000 4000 500 1000 100 --batch_size 50 --lr 0.0001 --dir_save /mnt/users/struski/local/chemia/multi_svm_classifers_all --use_dropout --class_weight
